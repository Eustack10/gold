...
<div class="container">
    <div class="row">
        <div class="col-sm-4 offset-sm-4 py-5">
            <h2 class="text-center">Edit Counter</h2>
            <form action="{{ route('admin.counter.update', $data->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-12 py-4 d-flex justify-content-end">
                        <a href="{{ route('admin.counter.index') }}" class="btn py-1" data-dismiss="modal">Close</a>
