                        ...
                        <div class="row">
                            <div class="col-12 col-md-10 d-flex flex-wrap">
                                ...
                                <div class="form-group mr-3 d-flex align-items-end">
                                    <button class="btn btn-dark btn-sm w-100" style="width: 70px !important"
                            ...
                            <div class="modal-body">
                                {{-- <div class="row">
                                    ...
                                    <div class="col-12 col-md-4 lot-card">
                                        <div class="border rounded d-flex flex-column justify-content-between p-3 lot-card-inner"
                                            onclick="select(this)">
