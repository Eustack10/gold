...
<div class="container">
    <div class="row">
        <div class="col-sm-4 offset-sm-4 py-5">
            <h2 class="text-center">Edit Goldsmith</h2>
            <form action="{{ route('admin.goldsmith.update', $data->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group m-0 mb-2">
                            ...
                            <textarea type="text" name="address1" class="form-control">{{ $data->address1 }}</textarea>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group m-0 mb-2">
                            ...
                            <textarea type="text" name="address2" class="form-control">{{ $data->address1 }}</textarea>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group m-0 mb-2">
                            ...
                            <textarea type="text" name="remark" class="form-control">{{ $data->remark }}</textarea>
