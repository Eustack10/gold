...
import LotModal from "./component/LotModal";
/* @params blade_gold */
const Weight = () => {
                        ...
                        <div className="tab-content" id="myTabContent">
                            ...
                            >
                                ...
                                <div className="bg-white p-2">
                                    ...
                                    <div className=" d-flex flex-wrap mt-2 lot-input">
                                        <div style={{ width: "15%" }}>
                                        ...
                                        <div className="ml-2 w-auto saveLot">
                                            <br />
                                            <button onClick={()=>setShowLotModal(true)} className="btn  btn-sm btn-outline-dark">
                                                + Lot
                                            </button>
                                        ...
                                        <LotModal show={showLotModal} handleClose={()=>setShowLotModal(false)} selectedCheck={selectedCheck} lots={lots} />
                                    </div>
                                    <table
                                        className="table"
                                        id="examplee"
